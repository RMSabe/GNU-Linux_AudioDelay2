...
class AudioRTDelay {
	...
	private:
		...
		__attribute__((__aligned__(PTR_SIZE_BITS))) float **pp_bufferinput_segments = NULL;
		__attribute__((__aligned__(PTR_SIZE_BITS))) float **pp_bufferoutput_segments = NULL;

		__attribute__((__aligned__(PTR_SIZE_BITS))) audiortdelay_fx_params_t *p_ff_params = NULL;
		__attribute__((__aligned__(PTR_SIZE_BITS))) audiortdelay_fx_params_t *p_fb_params = NULL;
