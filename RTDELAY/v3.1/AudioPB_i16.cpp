...
bool AudioPB_i16::audio_hw_init(void)
{
	...
	if(n_ret < 0)
	{
		...
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_open failed.");
		return false;
	}
	...
	{
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_malloc failed.");
		return false;
	}
	...
	if(n_ret < 0)
	{
		...
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_any failed.");
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_set_rate_resample failed.");
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_set_access failed.");
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_set_format failed.");
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_set_channels failed.");
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_set_rate failed.");
		return false;
	}
	...
	if(n_ret < 0)
	{
		...
		if(n_ret < 0)
		{
			snd_pcm_hw_params_free(p_hwparams);
			this->audio_hw_deinit();
			this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_set_buffer_size_near failed.");
			return false;
		}
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params_set_period_size failed.");
		return false;
	}
	...
	if(n_ret < 0)
	{
		snd_pcm_hw_params_free(p_hwparams);
		this->audio_hw_deinit();
		this->err_msg = __TEXT("AudioPB_i16::audio_hw_init: Error: snd_pcm_hw_params failed.");
		return false;
	}
...
void AudioPB_i16::buffer_load_in(void)
{
	...
	this->filein_pos += (__offset_t) this->AUDIOBUFFER_SEGMENT_SIZE_BYTES;
