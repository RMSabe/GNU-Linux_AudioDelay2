...
class AudioStream {
	...
	protected:
		...
		__attribute__((__aligned__(PTR_SIZE_BITS))) audiodevicelist_entry_t *p_audioinputdevicelist = NULL;
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t audioinputdevicelist_n_entries = 0u;

		__attribute__((__aligned__(PTR_SIZE_BITS))) audiodevicelist_entry_t *p_audiooutputdevicelist = NULL;
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t audiooutputdevicelist_n_entries = 0u;
		...
		bool audiodevicelist_alloc(audiodevicelist_entry_t **pp_devlist, size_t n_entries);
		void audiodevicelist_free(audiodevicelist_entry_t **pp_devlist);
