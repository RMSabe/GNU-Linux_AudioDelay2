...
{
	const size_t _BUFSIZE_BITMASK = (this->BUFFER_SIZE_FRAMES - 1u);
	...
	prev_buf_nframe = ((curr_buf_nframe - n_delay) & _BUFSIZE_BITMASK); /*Safe to use as long as BUFFER_SIZE_FRAMES is a power of 2. This is similar to (curr_buf_nframe - n_delay)%BUFFER_SIZE_FRAMES.*/
