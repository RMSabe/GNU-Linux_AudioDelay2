...
public class PlaybackRunningScreen extends MyScreen
{
	...
	private JRadioButton[] array_jradiobutton_rb_ffsel = new JRadioButton[CPPCore.RTDELAY_N_FFCH];
	...
	private JRadioButton[] array_jradiobutton_rb_fbsel = new JRadioButton[CPPCore.RTDELAY_N_FBCH];
	...
	public void init()
	{
		...
		rb_length = CPPCore.RTDELAY_N_FFCH;
		...
		rb_length = CPPCore.RTDELAY_N_FBCH;
	...
	private void alignContainer1()
	{
		...
		paramsin_size.height = (2 + CPPCore.RTDELAY_N_FFCH)*CONTAINERTEXT_FONTSIZE + CONTAINERTEXT_FONTSIZEMARGIN_TEXTAREA;
		...
		paramsout_size.height = (2 + CPPCore.RTDELAY_N_FBCH)*CONTAINERTEXT_FONTSIZE + CONTAINERTEXT_FONTSIZEMARGIN_TEXTAREA;
	...
	private void loadUpdateParams()
	{
		...
		for(nfx = 0; nfx < CPPCore.RTDELAY_N_FFCH; nfx++)
		{
			paramsin += "\nFF Channel ";
		...
		for(nfx = 0; nfx < CPPCore.RTDELAY_N_FBCH; nfx++)
		{
			paramsout += "\nFB Channel ";
