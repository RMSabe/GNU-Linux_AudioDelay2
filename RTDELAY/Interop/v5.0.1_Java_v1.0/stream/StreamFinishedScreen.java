...
public class StreamFinishedScreen extends MyScreen
{
	private static final String ACTIONCOMMAND_RETURNAUDIOSETUP = "RETURNAUDIOSETUP";
	...
	private ActionListener actionListener = new ActionListener() {
		...
		{
			if(event.getActionCommand().equals(ACTIONCOMMAND_RETURNAUDIOSETUP)) Main.switchToAudioSetupScreen();
		}
	};

	public StreamFinishedScreen(JFrame parentWindow)
	{
	...
	public void init()
	{
		...
		this.jlabel1.setText("Stream Finished");
		...
		this.jbutton1.setActionCommand(ACTIONCOMMAND_RETURNAUDIOSETUP);
