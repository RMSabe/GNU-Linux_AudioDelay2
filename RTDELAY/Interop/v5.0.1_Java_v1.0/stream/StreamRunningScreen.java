...
public class StreamRunningScreen extends MyScreen
{
	private static final String ACTIONCOMMAND_STOPSTREAM = "STOPSTREAM";
	private static final String ACTIONCOMMAND_PAUSERESUMESTREAM = "PAUSERESUMESTREAM";
	...
	private JButton jbutton_pauseresume = new JButton();
	...
	private JRadioButton[] array_jradiobutton_rb_ffsel = new JRadioButton[CPPCore.AUDIO_DELAY_N_FFCH];
	...
	private JRadioButton[] array_jradiobutton_rb_fbsel = new JRadioButton[CPPCore.AUDIO_DELAY_N_FBCH];
	...
	private ActionListener actionListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			if(eventCmd.equals(ACTIONCOMMAND_STOPSTREAM))
			{
				CPPCore.stopStream();
				return;
			}

			if(eventCmd.equals(ACTIONCOMMAND_PAUSERESUMESTREAM))
			{
				switch(CPPCore.getStatus())
				{
					case CPPCore.STATUS_RUNNING:
						CPPCore.pauseStream();
						jbutton_pauseresume.setText("Resume Stream");
						break;

					case CPPCore.STATUS_PAUSED:
						CPPCore.resumeStream();
						jbutton_pauseresume.setText("Pause Stream");
						break;
				}
	...
	public StreamRunningScreen(JFrame parentWindow)
	{
	...
	public void init()
	{
		...
		this.jlabel_title.setText("Stream Running");

		this.setupTextDefault(this.jlabel_subtitle);
		this.jlabel_subtitle.setFont(Definitions.SUBTITLE_FONT);
		...
		this.setupButtonDefault(this.jbutton_stop);
		this.jbutton_stop.setActionCommand(ACTIONCOMMAND_STOPSTREAM);
		this.jbutton_stop.setText("Stop Stream");

		this.setupButtonDefault(this.jbutton_pauseresume);
		this.jbutton_pauseresume.setActionCommand(ACTIONCOMMAND_PAUSERESUMESTREAM);
		this.jbutton_pauseresume.setText("Pause Stream");
		...
		this.add(this.jbutton_stop);
		this.add(this.jbutton_pauseresume);
		...
		rb_length = this.array_jradiobutton_rb_ffsel.length;
		...
		rb_length = this.array_jradiobutton_rb_fbsel.length;
	...
	public void deinit()
	{
		...
		this.jbutton_stop.removeActionListener(this.actionListener);
		this.jbutton_pauseresume.removeActionListener(this.actionListener);
		...
		rb_length = CPPCore.AUDIO_DELAY_N_FFCH;
		...
		rb_length = CPPCore.AUDIO_DELAY_N_FBCH;
		...
		this.remove(this.jbutton_stop);
		this.remove(this.jbutton_pauseresume);
	...
	public void align()
	{
		...
		Point b_stop_pos = new Point();
		Dimension b_stop_size = new Dimension();

		Point b_pauseresume_pos = new Point();
		Dimension b_pauseresume_size = new Dimension();
		...
		b_pauseresume_size.width = 200;
		b_pauseresume_size.height = 20;

		b_pauseresume_pos.x = center.x - b_pauseresume_size.width - Definitions.INTERCOMPONENT_MARGIN/2;
		b_pauseresume_pos.y = parentSize.height - b_pauseresume_size.height - Definitions.BOTTOM_WINDOW_MARGIN;

		b_stop_size.width = 200;
		b_stop_size.height = 20;

		b_stop_pos.x = center.x + Definitions.INTERCOMPONENT_MARGIN/2;
		b_stop_pos.y = parentSize.height - b_stop_size.height - Definitions.BOTTOM_WINDOW_MARGIN;
		...
		this.jbutton_pauseresume.setSize(b_pauseresume_size);
		this.jbutton_pauseresume.setLocation(b_pauseresume_pos);

		this.jbutton_stop.setSize(b_stop_size);
		this.jbutton_stop.setLocation(b_stop_pos);
	...
	private void alignContainer1()
	{
		...
		paramsin_size.height = (2 + CPPCore.AUDIO_DELAY_N_FFCH)*CONTAINERTEXT_FONTSIZE + CONTAINERTEXT_FONTSIZEMARGIN_TEXTAREA;
		...
		paramsout_size.height = (2 + CPPCore.AUDIO_DELAY_N_FBCH)*CONTAINERTEXT_FONTSIZE + CONTAINERTEXT_FONTSIZEMARGIN_TEXTAREA;
	...
	private void loadUpdateParams()
	{
		...
		for(nfx = 0; nfx < CPPCore.AUDIO_DELAY_N_FFCH; nfx++)
		{
			paramsin += "\nFF Channel ";
		...
		for(nfx = 0; nfx < CPPCore.AUDIO_DELAY_N_FBCH; nfx++)
		{
			paramsout += "\nFB Channel ";
