...
__EXTERNC__ JNIEXPORT jboolean JNICALL Java_CPPCore_chooseDevice(JNIEnv *p_jnienv, jclass jcls, jint index, jboolean output);
__EXTERNC__ JNIEXPORT jboolean JNICALL Java_CPPCore_chooseDefaultDevice(JNIEnv *p_jnienv, jclass jcls, jboolean output);
...
JNIEXPORT jboolean JNICALL Java_CPPCore_chooseDevice(JNIEnv *p_jnienv, jclass jcls, jint index, jboolean output)
{
	return (jboolean) choose_device((size_t) index, false, (bool) output);
}

JNIEXPORT jboolean JNICALL Java_CPPCore_chooseDefaultDevice(JNIEnv *p_jnienv, jclass jcls, jboolean output)
{
	return (jboolean) choose_device(0u, true, (bool) output);
}
