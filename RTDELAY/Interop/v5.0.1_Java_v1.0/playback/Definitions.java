 ...
 * Version 5.0.1 (Interop Java version 1.0)
 *
 * Author: Rafael Sabe
...
{
	public static final String MAINWND_CAPTION = "Real-Time Audio Delay";
	public static final Dimension MAINWND_INITSIZE = new Dimension(1280, 960);
	...
	public static final Color TEXTBOX_FOREGROUNDCOLOR = Color.BLACK;
	public static final Color TEXTBOX_BACKGROUNDCOLOR = Color.WHITE;

	public static final Color BUTTON_FOREGROUNDCOLOR = Color.BLACK;
	public static final Color BUTTON_BACKGROUNDCOLOR = Color.WHITE;

	public static final Color CONTAINER_BACKGROUNDCOLOR = new Color(0xe0, 0xe0, 0xe0);
	...
	public static final int SUBTITLE_FONTSIZE = 16;
	public static final int SUBTITLE_FONTSIZEMARGIN = 10;

	public static final Font TITLE_FONT = new Font(FONT_NAME, FONT_STYLE, TITLE_FONTSIZE);
	public static final Font SUBTITLE_FONT = new Font(FONT_NAME, FONT_STYLE, SUBTITLE_FONTSIZE);
}
