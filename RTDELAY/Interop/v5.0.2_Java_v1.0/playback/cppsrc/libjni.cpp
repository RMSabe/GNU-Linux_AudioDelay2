...
__EXTERNC__ JNIEXPORT jboolean JNICALL Java_CPPCore_chooseDevice(JNIEnv *p_jnienv, jclass jcls, jint index, jboolean enableResampling);
__EXTERNC__ JNIEXPORT jboolean JNICALL Java_CPPCore_chooseDefaultDevice(JNIEnv *p_jnienv, jclass jcls, jboolean enableResampling);
...
JNIEXPORT jboolean JNICALL Java_CPPCore_chooseDevice(JNIEnv *p_jnienv, jclass jcls, jint index, jboolean enableResampling)
{
	return (jboolean) choose_device((size_t) index, false, (bool) enableResampling);
}

JNIEXPORT jboolean JNICALL Java_CPPCore_chooseDefaultDevice(JNIEnv *p_jnienv, jclass jcls, jboolean enableResampling)
{
	return (jboolean) choose_device(0u, true, (bool) enableResampling);
}
