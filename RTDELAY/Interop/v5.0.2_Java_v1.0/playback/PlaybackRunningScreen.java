...
public class PlaybackRunningScreen extends MyScreen
{
			...
			while(!thread_timecursor_stop)
			{
				switch(CPPCore.getStatus())
				{
					...
					case CPPCore.STATUS_PAUSED:
						...
						audiodata_pos = CPPCore.getAudioDataPositionFrames();
						if(audiodata_pos >= 0L)
						{
	...
	private ActionListener actionListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			if(eventCmd.equals(ACTIONCOMMAND_PAUSERESUMEPLAYBACK))
			{
				switch(CPPCore.getStatus())
				{
					case CPPCore.STATUS_RUNNING:
						CPPCore.pausePlayback();
						jbutton_pauseresumepb.setText("Resume Playback");
						break;

					case CPPCore.STATUS_PAUSED:
						CPPCore.resumePlayback();
	...
	private ChangeListener changeListener = new ChangeListener() {
		...
		public void stateChanged(ChangeEvent event)
		{
			...
			{
				CPPCore.setAudioDataPositionFrames((long) jslider_timecursor.getValue());
	...
	public void init()
	{
		...
		this.setupButtonDefault(this.jbutton_pauseresumepb);
		this.jbutton_pauseresumepb.setActionCommand(ACTIONCOMMAND_PAUSERESUMEPLAYBACK);
		...
		audiodata_size = CPPCore.getAudioDataSizeFrames();
