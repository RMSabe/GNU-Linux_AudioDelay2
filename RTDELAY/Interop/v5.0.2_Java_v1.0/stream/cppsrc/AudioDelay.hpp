...
struct _audiodelay_init_params {
...
typedef struct _audiodelay_init_params audiodelay_init_params_t;

struct _audiodelay_fx_params {
	uint32_t delay;
	float amp;
};

typedef struct _audiodelay_fx_params audiodelay_fx_params_t;

class AudioDelay {
	public:
		AudioDelay(const audiodelay_init_params_t *p_params);
		~AudioDelay(void);

		bool setInitParameters(const audiodelay_init_params_t *p_params);
		...
		bool getFFParams(size_t n_fx, audiodelay_fx_params_t *p_params);
		bool getFBParams(size_t n_fx, audiodelay_fx_params_t *p_params);
	...
	private:
		...
		static constexpr size_t BUFFER_N_SEGMENTS_MIN = 1u; /*Must have at least 1 segment*/
		static constexpr size_t N_CHANNELS_MIN = 1u;

		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t BUFFER_SIZE_FRAMES = 0u;
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t BUFFER_SIZE_SAMPLES = 0u;
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t BUFFER_SIZE_BYTES = 0u;

		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t BUFFER_N_SEGMENTS = 0u;

		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t BUFFER_SEGMENT_SIZE_FRAMES = 0u;
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t BUFFER_SEGMENT_SIZE_SAMPLES = 0u;
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t BUFFER_SEGMENT_SIZE_BYTES = 0u;
		...
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t P_FF_PARAMS_LENGTH = 0u;
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t P_FF_PARAMS_SIZE = 0u;

		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t P_FB_PARAMS_LENGTH = 0u;
		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t P_FB_PARAMS_SIZE = 0u;

		__attribute__((__aligned__(PTR_SIZE_BITS))) size_t N_CHANNELS = 0u;

		__attribute__((__aligned__(PTR_SIZE_BITS))) float *p_bufferinput = NULL;
		__attribute__((__aligned__(PTR_SIZE_BITS))) float *p_bufferoutput = NULL;

		__attribute__((__aligned__(PTR_SIZE_BITS))) audiodelay_fx_params_t *p_ff_params = NULL;
		__attribute__((__aligned__(PTR_SIZE_BITS))) audiodelay_fx_params_t *p_fb_params = NULL;

		__attribute__((__aligned__(32))) float dryinput_amp = 0.0f;
		__attribute__((__aligned__(32))) float output_amp = 0.0f;
