...
public class ChooseFileScreen extends MyScreen
{
	...
	private ActionListener actionListener = new ActionListener() {
		...
		{
			if(event.getActionCommand().equals(ACTIONCOMMAND_CHOOSEFILE)) procOpenFileDialog();
		}

	};

	public ChooseFileScreen(JFrame parent)
	{
		this.parent = parent;
		this.init();
	}
	...
	public void init()
	{
		...
		this.jbutton1.setActionCommand(ACTIONCOMMAND_CHOOSEFILE);
	...
	private void procOpenFileDialog()
	{
		...
		{
			CPPCore.setFileInDir(jfilechooser.getSelectedFile().getAbsolutePath());
