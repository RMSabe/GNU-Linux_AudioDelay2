...
extern bool loadfile_createaudioobject(procctx_t *p_procctx);

extern bool load_audiodevicelist(procctx_t *p_procctx);
extern ssize_t audiodevicelist_get_entry_count(procctx_t *p_procctx);
extern const char* audiodevicelist_get_entry_info(procctx_t *p_procctx, size_t index, bool info);
extern bool choose_device(procctx_t *p_procctx, size_t index, bool defaultdev);

extern bool audioobject_init(procctx_t *p_procctx);
extern bool run_playback(procctx_t *p_procctx);
